...
function activate(context) {
    ...
    const es5_es6 = vscode.commands.registerCommand('extension.lebab', () => {
        ...
        const { code, warnings } = (0, lebab_1.transform)(textCode, ['arrow', 'let', 'for-of', 'for-each', 'arg-rest', 'arg-spread', 'obj-method', 'obj-shorthand', 'no-strict', 'exponent', 'template']);
